...
def generate_database(trajectory_path):
    trajectory_pairs = []
    global run_type, saved_segments
...
def run_simulation(genomes, config):
    ...
    while True:
        ...
        if counter == TRAJECTORY_LENGTH or still_alive == 0:
            ...
            if (
                run_type == "collect"
                and len(saved_segments) >= number_of_trajectories
            ):
                pygame.display.quit()
                pygame.quit()
            break
...
def run_population(
    ...
    try:
        ...
        global population, saved_segments
        ...
        while True:
            ...
            if run_type == "collect" and len(saved_segments) == number_of_trajectories:
