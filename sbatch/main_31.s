#!/bin/bash
#SBATCH --job-name=collect_data_split
#SBATCH --output=collect_data_split_%j.out
#SBATCH --error=collect_data_split_%j.err
...
srun --exclusive ./scripts/run_basic.sh -r 3 -p -h_
