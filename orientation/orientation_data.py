...
class Car:
    ...
    def update(self, game_map):
        ...
        with open("orientation_data.csv", "a") as csvfile:
            writer = csv.writer(csvfile)
            writer.writerow([self.position[0], self.position[1], self.angle % 360])
        print("Position: ", self.position, "Angle: ", self.angle % 360)
